package com.moelattar.bostatask.common.interactor
...
abstract class BaseUseCase<out Model, in Params> {
    ...
    private fun handleError(e: Exception): BostaTaskException {
        return if (e is BostaTaskException) e
        else BostaTaskException.Unknown(message = "Unknown error in $this: $e")
    }
}